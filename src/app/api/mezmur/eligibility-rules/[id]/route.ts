// src/app/api/mezmur/eligibility-rules/[id]/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/mezmur/eligibility-rules/[id] error:", error);
    return NextResponse.json(
  ...
  try {
    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      await tx.eligibilityCriteria.deleteMany({
        where: { eligibilityRuleId: id, mode: 'MEZMUR' },
      });
    ...
    console.error("PUT /api/mezmur/eligibility-rules/[id] error:", error);
    return NextResponse.json(
      { 
...
export async function DELETE(
  ...
  try {
    ...
    console.error("DELETE /api/mezmur/eligibility-rules/[id] error:", error);
    return NextResponse.json(
      { 
