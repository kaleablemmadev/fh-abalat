// src/app/api/mezmur/permission-types/[id]/route.ts
import { NextRequest, NextResponse } from 'next/server';
import prisma from '@/src/lib/prisma';

// GET - Get a single mezmur permission type
export async function GET(
  ...
  try {
    ...
    console.error('Error fetching mezmur permission type:', error);
    return NextResponse.json(
...
// PUT - Update a mezmur permission type
export async function PUT(
  ...
  try {
    ...
    console.error('Error updating mezmur permission type:', error);
    return NextResponse.json(
...
// DELETE - Delete a mezmur permission type
export async function DELETE(
  ...
  try {
    ...
    console.error('Error deleting mezmur permission type:', error);
    return NextResponse.json(
