          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                style={{ background: 'hsl(217 70% 32%)', color: '#fff' }}
              >
      ...
      <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="superadmin@course.com"
                className="w-full pl-10 pr-4 py-2 rounded border text-sm"
                style={{
        ...
        <div className="text-center pt-4 border-t" style={{ borderColor: 'hsl(var(--border))' }}>
          <p className="text-xs" style={{ color: 'hsl(var(--muted-foreground))' }}>
            New admin? <a href="/course/admin-registration" className="font-semibold underline" style={{ color: 'hsl(var(--primary))' }}>Register here</a>
          </p>
        </div>
      </div>
    </div>
