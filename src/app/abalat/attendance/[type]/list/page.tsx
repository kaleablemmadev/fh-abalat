// /abalat/attendance/[type]/list/page.tsx
    ...
    <div className="space-y-6 animate-fade-in">
      <Breadcrumb
        items={[
          ...
          { label: `${isChore ? 'የሠርክ' : 'የእሑድ'} አቴንዳንስ ዝርዝር` },
        ]}
      />

      <div>
        <h1 className="text-2xl font-bold tracking-tight" style={{ color: 'hsl(var(--foreground))' }}>
          {isChore ? 'የሠርክ' : 'የእሑድ'} አቴንዳንስ ዝርዝር
        </h1>
        <p className="text-sm mt-0.5" style={{ color: 'hsl(var(--muted-foreground))' }}>
          የቀደሙ {isChore ? 'የሠርክ አገልግሎት አቴንዳንሶች' : 'የኧሑድ ጉባዔ አቴንዳንሶች'}
        </p>
      </div>
        ...
        {events.length === 0 ? (
          <div className="flex flex-col items-center justify-center p-12">
            ...
            <p className="text-lg font-medium" style={{ color: 'hsl(var(--foreground))' }}>
              ምንም {isChore ? 'የሠርክ' : 'የአቴንዳንስ'} አቴንዳንስ የለም
            </p>
            <p className="text-sm mt-1" style={{ color: 'hsl(var(--muted-foreground))' }}>
              ወደ {isChore ? 'ሠርክ' : 'እሑድ'} አቴንዳንስ ገጽ ሄደህ መዝግብ
            </p>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Users size={12} />
                      የተቆጠሩ {event._count.attendances} አቴንዳንሶች
                    </span>
                    <Link
