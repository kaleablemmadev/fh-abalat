// src/app/api/mezmur/permission-types/route.ts
import { NextRequest, NextResponse } from 'next/server';
import prisma from '@/src/lib/prisma';

// GET - List all mezmur permission types
export async function GET() {
  try {
    ...
    console.error('Error fetching mezmur permission types:', error);
...
// POST - Create a new mezmur permission type
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating mezmur permission type:', error);
    return NextResponse.json(
