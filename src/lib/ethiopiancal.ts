...
// Reference: Gregorian 2014-09-11 = Ethiopian 2007-01-01 (Meskerem 1, 2007)
// Reference: Gregorian 2024-07-20 = Ethiopian 2017-11-12 (Hamle 12, 2017)
function absoluteDaysToEthiopian(absDays: number): EthDate {
  const refGreg: GregorianDate = { year: 2014, month: 9, day: 11 };
  const refEth: EthDate = { year: 2007, month: 1, day: 1 };
