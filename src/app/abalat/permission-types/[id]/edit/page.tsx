// /abalat/permission-types/[id]/edit/page.tsx
'use client';
...
export default function EditPermissionTypePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/abalat/permission-types');
      router.refresh();
    } catch (err) {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-2xl">
      <Breadcrumb
        items={[
          { label: 'የፈቃድ ዐይነቶች', href: '/abalat/permission-types' },
          { label: name || 'አስተካክል' },
          { label: 'አስተካክል' },
        ]}
      />
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              required
              placeholder="ምሳሌ... የ2 ወር ፈቃድ፣ የሠርክ ፈቃድ፤ ..."
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={2}
              placeholder="ይህ ፈቃድ መቼና ለማን እንደሚያገለግል አብራራ..."
            />
          </div>
