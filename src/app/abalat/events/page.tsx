      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded px-3 py-2 text-sm font-semibold transition-colors duration-150 hover:bg-[hsl(160_70%_38%)]"
            style={{
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-1 flex-wrap">
                      ...
                      <Link
                        href={`/abalat/events/${e.id}/eligibility`}
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <Link
                      href={`/abalat/events/${e.id}`}
                      className="inline-flex items-center gap-1 text-sm font-medium transition-colors duration-150 hover:text-[hsl(160_60%_65%)]"
                      style={{ color: 'hsl(160 60% 55%)' }}
                    >
                      ዝርዝር
                      <ChevronRight size={14} />
                    ...
                    <button
                      ...
                      disabled={isDeleting}
                      className="inline-flex items-center gap-1 rounded px-2 py-1 text-xs font-medium transition-colors duration-150 disabled:opacity-50 hover:bg-[hsl(0_40%_18%)] hover:text-[hsl(0_55%_65%)]"
                      style={{
