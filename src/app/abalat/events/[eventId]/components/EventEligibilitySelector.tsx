// /abalat/events/[eventId]/components/EventEligibilitySelector.tsx
'use client';
        ...
        {selectedRule && (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <Link
                href={`/abalat/events/${eventId}/eligibility`}
